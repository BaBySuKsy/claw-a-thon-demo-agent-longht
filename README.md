...
Mở rộng MVP (Data Platform domain) → **Acme Knowledge Operating System** toàn công ty: vector DB persistent, ingest toàn Confluence, full cross-team lineage tự động (parse SQL/DAG), action write-back (gửi thật Jira/Slack/MR), hosted live mode (VPC). Chi tiết: [`docs/ROADMAP.md`](docs/ROADMAP.md).
...
<div align="center">
<sub><b>Acme Data Platform AI</b> · GreenNode Claw-a-thon 2026 · Powered by MiniMax-M2.5 on GreenNode AgentBase</sub>
</div>
