...
> [!NOTE]
> **Synthetic data — safe to explore.** This repository and the live demo run on a **fully
> synthetic, fictional dataset** (company "Acme"). **No production data is used** — this is a
> deliberate choice to eliminate any risk of leaking internal/sensitive information, while still
> letting anyone experience the agent end-to-end. All tables, pipelines, teams, owners, docs,
> Jira tickets and commit history are generated by `scripts/generate_synthetic_data.py`; the
> agent's answers are accurate and internally consistent, but the underlying data is not real.
>
