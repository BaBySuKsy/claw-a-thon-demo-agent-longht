...
**To enable true Live on a hosted endpoint:** deploy in VPC mode (requires IAM network permission + peering to the corporate network — see `Deploy_Runbook.md §5b`).

---

*Cập nhật / Updated: 2026-06-16. Liên quan: `Deploy_Runbook.md §5b` (VPC mode), `run_local.sh` (chạy local để demo LIVE).*
